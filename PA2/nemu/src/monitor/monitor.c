...
//static char *img_file = "/home/misaki/ics2020/nexus-am/tests/cputest/build/add-x86-nemu.bin";
//static char *img_file = "/home/misaki/ics2020/nexus-am/tests/cputest/build/dummy-x86-nemu.bin";
...
int init_monitor(int argc, char *argv[]) {
  ...
  /* Parse arguments. */
  parse_args(argc, argv);//parse command line arguments 'b a l d'
 
  /* Open the log file. */
  init_log(log_file);//defined in /debug/log.c, open the log file with ' w '

  /* Load the image to memory. */
  long img_size = load_img();//load the image to memory and return its size
